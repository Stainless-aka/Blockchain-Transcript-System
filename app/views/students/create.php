<div class="row">
    <div class="col-lg-8 mx-auto">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h5 class="fw-bold mb-0"><i class="bi bi-person-plus me-2 text-primary"></i>Add New Student</h5>
                <p class="text-muted small mb-0">Fill in the student's information below.</p>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                <form action="<?= url('students/store') ?>" method="POST" novalidate>
                    <?= csrfField() ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="matric_number" class="form-control <?= !empty($errors['matric_number']) ? 'is-invalid' : '' ?>"
                                   value="<?= e($old['matric_number'] ?? '') ?>" required>
